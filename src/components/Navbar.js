  ...
  return (
    <div className="flex justify-between py-5 px-10 items-center fixed w-full bg-white z-20 dark:bg-slate-700 dark:text-white">
      ...
      <ul className="flex items-center">
        ...
        <li className="text-lg ml-10 py-1 px-3 rounded-lg cursor-pointer opacity-90 hover:opacity-100 hover:shadow-md shadow-slate-500 gradient dark:bg-gradient-to-r dark:from-slate-500 dark:to-slate-400"><a href="#">Resume</a></li>
      </ul>
    </div>
  )
}
